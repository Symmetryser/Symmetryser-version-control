...
C_Network=[0, 0, 0];                                %[F]
%% Malfunctions
TransformerShortcut=[1e5,1e5,1e5;...                %[Shortcut RSTN line at given sim.time]
                     1e5,1e5,1e5];
NetworkBreaker=[1e5,1e5,1e5,1e5];                     %[Break RSTN line at given sim.time]
%% Loads
%%Ohmic Loads%%%
Load_R=[50,50,50;...                                %[HouseHold_1]
        50,50,50;...                                %[HouseHold_2]                      
        50,50,50];                                  %[HouseHold_3]
START_Load_R= [0.001,100,100;...                    %[HouseHold_1]
               0.001,100,100;...                    %[HouseHold_2]
               0.001,100,100];                      %[HouseHold_3] 
%%Inductive Loads%%%
Load_RL=[35.35,   35.35,   35.35;...                %[HouseHold_1]
         0.1125,  0.1125,  0.1125;...        
         35.35,   35.35,   35.35;...                %[HouseHold_2]
         0.1125,  0.1125,  0.1125;...         
         35.35,   35.35,   35.35;...                %[HouseHold_3]
         0.1125,  0.1125,  0.1125];                          
START_Load_RL= [0.001,100,100;...                   %[HouseHold_1]
                0.001,100,100;...                   %[HouseHold_2]
                0.001,100,100];                     %[HouseHold_3]              
%%Capacitive Loads%%%
Capacitive_Load_RC=[60e-3,  120e-3,  80e-3;...      %[HouseHold_1]
                    1e-3, 5e-3, 3e-3;...  
                    60e-3,  120e-3,  80e-3;...      %[HouseHold_2]
                    1e-3, 5e-3, 3e-3;...  
                    60e-3,  120e-3,  80e-3;...      %[HouseHold_3]
                    1e-3, 5e-3, 3e-3];                        
START_Load_RC= [0.001,100,100;...                   %[HouseHold_1]
                0.001,100,100;...                   %[HouseHold_2]
                0.001,100,100];                     %[HouseHold_3]
%% CurrentGenerator 
