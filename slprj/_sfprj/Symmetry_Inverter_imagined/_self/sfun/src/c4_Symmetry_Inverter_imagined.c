...
static void finalize_c4_Symmetry_Inverter_imagined
  (SFc4_Symmetry_Inverter_imaginedInstanceStruct *chartInstance);
static void sf_gateway_c4_Symmetry_Inverter_imagined
  (SFc4_Symmetry_Inverter_imaginedInstanceStruct *chartInstance);
  ...
  (SFc4_Symmetry_Inverter_imaginedInstanceStruct *chartInstance)
{
  ...
  for (c4_i2 = 0; c4_i2 < 3; c4_i2++) {
    c4_phase[c4_i2] = (*c4_b_phase)[c4_i2];
  }
  ...
  c4_x = 6.2831853071795862 * c4_CC_mtx[3] * c4_t + c4_CC_mtx[6];
  c4_b_x = c4_x;
  c4_b_x = muDoubleScalarSin(c4_b_x);
  c4_c_x = 6.2831853071795862 * c4_CC_mtx[4] * c4_t + c4_CC_mtx[7];
  c4_d_x = c4_c_x;
  c4_d_x = muDoubleScalarSin(c4_d_x);
  c4_e_x = 6.2831853071795862 * c4_CC_mtx[5] * c4_t + c4_CC_mtx[8];
  c4_f_x = c4_e_x;
  c4_f_x = muDoubleScalarSin(c4_f_x);
  c4_b_CC_mtx[0] = c4_CC_mtx[0] * c4_b_x + c4_CC_mtx[9];
  c4_b_CC_mtx[1] = c4_CC_mtx[1] * c4_d_x + c4_CC_mtx[10];
  c4_b_CC_mtx[2] = c4_CC_mtx[2] * c4_f_x + c4_CC_mtx[11];
  for (c4_i4 = 0; c4_i4 < 3; c4_i4++) {
    c4_CC[c4_i4] = c4_b_CC_mtx[c4_i4];
  }

  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, -13);
  _SFD_SYMBOL_SCOPE_POP();
  for (c4_i5 = 0; c4_i5 < 3; c4_i5++) {
    (*c4_b_CC)[c4_i5] = c4_CC[c4_i5];
  }
  ...
  for (c4_i6 = 0; c4_i6 < 3; c4_i6++) {
    _SFD_DATA_RANGE_CHECK((*c4_b_CC)[c4_i6], 1U);
  }

  for (c4_i7 = 0; c4_i7 < 3; c4_i7++) {
    _SFD_DATA_RANGE_CHECK((*c4_b_phase)[c4_i7], 2U);
  }
  ...
  (void)
{
  ...
  sf_mex_assign(&c4_nameCaptureInfo, sf_mex_createstruct("structure", 2, 9, 1),
                false);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4231771221U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2801522371U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4202336808U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3603619950U);
}
...
mxArray *sf_c4_Symmetry_Inverter_imagined_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("QhAUgpc9OAd5Vl0psdYwnF");
...
mxArray *sf_c4_Symmetry_Inverter_imagined_updateBuildInfo_args_info(void)
{
...
static void sf_opaque_gateway_c4_Symmetry_Inverter_imagined(void
  *chartInstanceVar)
{
  sf_gateway_c4_Symmetry_Inverter_imagined
    ((SFc4_Symmetry_Inverter_imaginedInstanceStruct*) chartInstanceVar);
}
  ...
  const mxArray *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c4_Symmetry_Inverter_imagined();/* state var info */
...
static void mdlSetWorkWidths_c4_Symmetry_Inverter_imagined(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1913152530U));
  ssSetChecksum1(S,(4278764148U));
  ssSetChecksum2(S,(2989293477U));
  ssSetChecksum3(S,(3749163381U));
