...
static void finalize_c5_Symmetry_Inverter_imagined
  (SFc5_Symmetry_Inverter_imaginedInstanceStruct *chartInstance);
static void sf_gateway_c5_Symmetry_Inverter_imagined
  (SFc5_Symmetry_Inverter_imaginedInstanceStruct *chartInstance);
  ...
  (SFc5_Symmetry_Inverter_imaginedInstanceStruct *chartInstance)
{
  ...
  for (c5_i6 = 0; c5_i6 < 3; c5_i6++) {
    c5_CC[c5_i6] = c5_b_CC_mtx[c5_i6];
  }

  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, -13);
  _SFD_SYMBOL_SCOPE_POP();
  for (c5_i7 = 0; c5_i7 < 3; c5_i7++) {
    (*c5_b_CC)[c5_i7] = c5_CC[c5_i7];
  }
  ...
  for (c5_i8 = 0; c5_i8 < 3; c5_i8++) {
    _SFD_DATA_RANGE_CHECK((*c5_b_CC)[c5_i8], 1U);
  }

  for (c5_i9 = 0; c5_i9 < 3; c5_i9++) {
    _SFD_DATA_RANGE_CHECK((*c5_b_phase)[c5_i9], 2U);
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(455698923U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1982769912U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1150506737U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(375347428U);
}
...
mxArray *sf_c5_Symmetry_Inverter_imagined_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("cUHvHJHPjVDDEQG4SfhjXD");
...
mxArray *sf_c5_Symmetry_Inverter_imagined_updateBuildInfo_args_info(void)
{
...
static void sf_opaque_gateway_c5_Symmetry_Inverter_imagined(void
  *chartInstanceVar)
{
  sf_gateway_c5_Symmetry_Inverter_imagined
    ((SFc5_Symmetry_Inverter_imaginedInstanceStruct*) chartInstanceVar);
}
  ...
  const mxArray *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c5_Symmetry_Inverter_imagined();/* state var info */
...
static void mdlSetWorkWidths_c5_Symmetry_Inverter_imagined(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(78768171U));
  ssSetChecksum1(S,(1606909285U));
  ssSetChecksum2(S,(30889124U));
  ssSetChecksum3(S,(399506768U));
