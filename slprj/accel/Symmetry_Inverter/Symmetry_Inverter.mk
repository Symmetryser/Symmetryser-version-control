...
MODEL              = Symmetry_Inverter
MODULES            = HostLib_FFT.c HostLib_rtw.c Symmetry_Inverter_acc_data.c rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c rt_zcfcn.c 
MAKEFILE           = Symmetry_Inverter.mk
MATLAB_ROOT        = C:/Program Files/MATLAB/R2014a
ALT_MATLAB_ROOT    = C:/PROGRA~1/MATLAB/R2014a
MASTER_ANCHOR_DIR  = 
START_DIR          = D:/MatlabGyak/Symmetry/Symmetryser-version-control
MATLAB_BIN         = C:/Program Files/MATLAB/R2014a/bin
ALT_MATLAB_BIN     = C:/PROGRA~1/MATLAB/R2014a/bin
S_FUNCTIONS        = sfun_spssw_contc.c sf_sfun.c sfun_psbbreaker.c
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 11
TID01EQ            = 0
...
MODELLIB                  = Symmetry_Inverterlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(MATLAB_ROOT)/toolbox/shared/dspblks/extern/include \
	-I$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include \
	-I$(START_DIR)/slprj/accel/Symmetry_Inverter \
	-I$(START_DIR) \
...
%.obj : $(MATLAB_ROOT)/toolbox/shared/dspblks/extern/src/%.c
	$(CC) $(MEX_FLAGS) $(INCLUDES) -Fo$(@F) $<

%.obj : $(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include/%.c
	$(CC) $(MEX_FLAGS) $(INCLUDES) -Fo$(@F) $<
