...
slZcSignalSignType ) ( ( ( uint8_T ) ( * prevZc ) ) & 0x03 ) ;
...
SL_ZCS_EVENT_ALL_DN ) { zcEvent = FALLING_ZCEVENT ; } else if ( currEv &
SL_ZCS_EVENT_ALL_UP ) { zcEvent = RISING_ZCEVENT ; } else { zcEvent =
NO_ZCEVENT ; } return zcEvent ; }
